...
public class WomenbutAdapter extends BaseAdapter {
    private LayoutInflater inflater;
    private List<String> list = new ArrayList<String>();
    private Context context;
    private List<Small.WomensanjiaoEntity> entitylist;
    private ContentValues contentValues;
    private SQLiteDatabase database;

    public WomenbutAdapter(Context context, List<Small.WomensanjiaoEntity> entitylist, ContentValues contentValues, SQLiteDatabase database) {
