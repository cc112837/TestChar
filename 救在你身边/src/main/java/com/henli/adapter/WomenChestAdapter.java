...
public class WomenChestAdapter extends BaseAdapter {
    private LayoutInflater inflater;
    private List<String> list = new ArrayList<String>();
    private Context context;
    private List<Small.WomenchestEntity> entitylist;
    private ContentValues contentValues;
    private SQLiteDatabase database;

    public WomenChestAdapter(Context context, List<Small.WomenchestEntity> entitylist, ContentValues contentValues, SQLiteDatabase database) {
