...
public class HeadAdapter extends BaseAdapter {
    ...
    private List<Small.HeadEntity> entitylist;
    private ContentValues contentValues;
    private SQLiteDatabase database;

    public HeadAdapter(Context context, List<Small.HeadEntity> entitylist, ContentValues contentValues, SQLiteDatabase database) {
