...
public class LegAdapter extends BaseAdapter {
    ...
    private List<Small.LegEntity> entitylist;
    private ContentValues contentValues;
    private SQLiteDatabase database;

    public LegAdapter(Context context, List<Small.LegEntity> entitylist, ContentValues contentValues, SQLiteDatabase database) {
