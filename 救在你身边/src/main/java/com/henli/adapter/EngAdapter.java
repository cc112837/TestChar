...
public class EngAdapter extends BaseAdapter {
    ...
    private List<Small.EngenderEntity> entitylist;
    private ContentValues contentValues;
    private SQLiteDatabase database;

    public EngAdapter(Context context, List<Small.EngenderEntity> entitylist, ContentValues contentValues, SQLiteDatabase database) {
