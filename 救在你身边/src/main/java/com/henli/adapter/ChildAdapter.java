...
public class ChildAdapter extends BaseAdapter {
    ...
    private List<Small.ChildrenEntity> entitylist;
    private ContentValues contentValues;
    private SQLiteDatabase database;

    public ChildAdapter(Context context, List<Small.ChildrenEntity> entitylist, ContentValues contentValues, SQLiteDatabase database) {
