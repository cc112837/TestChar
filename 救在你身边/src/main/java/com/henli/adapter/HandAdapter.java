...
public class HandAdapter extends BaseAdapter {
    ...
    private List<Small.HandEntity> entitylist;
    private ContentValues contentValues;
    private SQLiteDatabase database;


    public HandAdapter(Context context, List<Small.HandEntity> entitylist, ContentValues contentValues, SQLiteDatabase database) {
